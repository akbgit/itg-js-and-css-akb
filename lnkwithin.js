...
if(window.location.search.indexOf("lw_show_p=1")!=-1){extra+="&show_p=1";} 
...
LW.stc(i);if(p){LW.c(LW.u+'show_widget_promo'+'?site_id='+linkwithin_site_id+'&url='+escape(window.location)+'&callback=LW.swp'+'&widget_id='+i+'&width='+width+'&permalink='+escape(LW.ps[i]?LW.gl(LW.ps[i]):'')+'&version='+LW.v);}}};LW.swp=function(r,i,m){var e=document.getElementById("linkwithin_posts_"+i);if(e&&r){if(m=='replace'){var e2=document.getElementById("linkwithin_link_last");e.removeChild(e2);e.innerHTML+=r;}
...
LW.stc(i);}};LW.gcs=function(e,s){var cs;if(typeof e.currentStyle!='undefined')
{cs=e.currentStyle;}
else
